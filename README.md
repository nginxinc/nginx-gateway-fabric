...
\*the installation manifests use the minor version of nginx (e.g. 1.25) and the patch version is not specified. This means that the latest available patch version of nginx is used.
