...
| `gateway.namespace`                                     | The namespace of the Gateway resource.                                                                                                                                                                   | ""                                                                                                              |
...
| `gateway.listeners.tls.certificate.namespace`           | The namespace of the Gateway resource certificate. Only a single reference to a Secret is supported.                                                                                                     | ""                                                                                                              |
