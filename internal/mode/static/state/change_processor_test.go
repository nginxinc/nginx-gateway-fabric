	...
	"ChangeProcessor", func() {
		...
		Describe(
			"Normal cases of processing changes", func() {
				...
				Describe(
					"Process gateway resources", Ordered, func() {
						var (
						...
						When(
							"no upsert has occurred", func() {
								It(
									"returns nil graph", func() {
						...
						When(
							"GatewayClass doesn't exist", func() {
								When(
									"Gateway API CRD is added", func() {
										It(
											"returns empty graph", func() {
								...
								When(
									"Gateways don't exist", func() {
										When(
											"the first HTTPRoute is upserted", func() {
												It(
													"returns empty graph", func() {
										...
										When(
											"the first TLSRoute is upserted", func() {
												It(
													"returns empty graph", func() {
										...
										When(
											"the different namespace TLS Secret is upserted", func() {
												It(
													"returns nil graph", func() {
										...
										When(
											"the first Gateway is upserted", func() {
												It(
													"returns populated graph", func() {
						...
						When(
							"the GatewayClass is upserted", func() {
								It(
									"returns updated graph", func() {
						...
						When(
							"the ReferenceGrant allowing the Gateway to reference its Secret is upserted", func() {
								It(
									"returns updated graph", func() {
						...
						When(
							"the ReferenceGrant allowing the hr1 to reference the Service in different ns is upserted",
							func() {
								It(
									"returns updated graph", func() {
						...
						When(
							"the ReferenceGrant allowing the tr1 to reference the Service in different ns is upserted",
							func() {
								It(
									"returns updated graph", func() {
						...
						When(
							"the Gateway API CRD with bundle version annotation change is processed", func() {
								It(
									"returns updated graph", func() {
						...
						When(
							"the Gateway API CRD without bundle version annotation change is processed", func() {
								It(
									"returns nil graph", func() {
						...
						When(
							"the first HTTPRoute update with a generation changed is processed", func() {
								It(
									"returns populated graph", func() {
						...
						When(
							"the first TLSRoute update with a generation changed is processed", func() {
								It(
									"returns populated graph", func() {
						...
						When(
							"the first Gateway update with a generation changed is processed", func() {
								It(
									"returns populated graph", func() {
						...
						When(
							"the GatewayClass update with generation change is processed", func() {
								It(
									"returns populated graph", func() {
						...
						When(
							"the different namespace TLS secret is upserted again", func() {
								It(
									"returns populated graph", func() {
										processor.CaptureUpsertChange(diffNsTLSSecret)
						...
						When(
							"the same namespace TLS Secret is upserted", func() {
								It(
									"returns nil graph", func() {
						...
						When(
							"the second Gateway is upserted", func() {
								It(
									"returns populated graph using first gateway", func() {
						...
						When(
							"the second HTTPRoute is upserted", func() {
								It(
									"returns populated graph", func() {
						...
						When(
							"the second TLSRoute is upserted", func() {
								It(
									"returns populated graph", func() {
						...
						When(
							"the first Gateway is deleted", func() {
								It(
									"returns updated graph", func() {
						...
						When(
							"the second HTTPRoute is deleted", func() {
								It(
									"returns updated graph", func() {
										processor.CaptureDeleteChange(
											&v1.HTTPRoute{},
						...
						When(
							"the second TLSRoute is deleted", func() {
								It(
									"returns updated graph", func() {
										processor.CaptureDeleteChange(
											&v1alpha2.TLSRoute{},
						...
						When(
							"the GatewayClass is deleted", func() {
								It(
									"returns updated graph", func() {
										processor.CaptureDeleteChange(
											&v1.GatewayClass{},
						...
						When(
							"the second Gateway is deleted", func() {
								It(
									"returns empty graph", func() {
										processor.CaptureDeleteChange(
											&v1.Gateway{},
						...
						When(
							"the first HTTPRoute is deleted", func() {
								It(
									"returns empty graph", func() {
										processor.CaptureDeleteChange(
											&v1.HTTPRoute{},
				...
				Describe(
					"Process services and endpoints", Ordered, func() {
						var (
						...
						When(
							"a backendTLSPolicy is added for referenced service", func() {
								It(
									"should trigger a change", func() {
						...
						When(
							"an hr1 endpoint slice is added", func() {
								It(
									"should trigger a change", func() {
						...
						When(
							"an hr1 service is updated", func() {
								It(
									"should trigger a change", func() {
										testUpsertTriggersChange(hr1svc, state.ClusterStateChange)
									},
						...
						When(
							"another hr1 endpoint slice is added", func() {
								It(
									"should trigger a change", func() {
						...
						When(
							"an endpoint slice with a missing svc name label is added", func() {
								It(
									"should not trigger a change", func() {
						...
						When(
							"an hr1 endpoint slice is deleted", func() {
								It(
									"should trigger a change", func() {
						...
						When(
							"the second hr1 endpoint slice is deleted", func() {
								It(
									"should trigger a change", func() {
										testDeleteTriggersChange(
											hr1slice2,
						...
						When(
							"the second hr1 endpoint slice is recreated", func() {
								It(
									"should trigger a change", func() {
										testUpsertTriggersChange(hr1slice2, state.EndpointsOnlyChange)
									},
						...
						When(
							"a hr3, that shares a backend service with hr2, is added", func() {
								It(
									"should trigger a change", func() {
						...
						When(
							"sharedSvc, a service referenced by both hr2 and hr3, is added", func() {
								It(
									"should trigger a change", func() {
						...
						When(
							"a service that is not referenced by any route is added", func() {
								It(
									"should not trigger a change", func() {
						...
						When(
							"a route with an invalid backend ref type is added", func() {
								It(
									"should trigger a change", func() {
						...
						When(
							"a service with a namespace name that matches invalid backend ref is added", func() {
								It(
									"should not trigger a change", func() {
						...
						When(
							"an endpoint slice that is not owned by a referenced service is added", func() {
								It(
									"should not trigger a change", func() {
						...
						When(
							"an endpoint slice that is not owned by a referenced service is deleted", func() {
								It(
									"should not trigger a change", func() {
										testDeleteTriggersChange(
											noRefSlice,
						...
						Context(
							"processing a route with multiple rules and three unique backend services", func() {
								When(
									"route is added", func() {
										It(
											"should trigger a change", func() {
								...
								When(
									"first referenced service is added", func() {
										It(
											"should trigger a change", func() {
								...
								When(
									"second referenced service is added", func() {
										It(
											"should trigger a change", func() {
								...
								When(
									"first referenced service is deleted", func() {
										It(
											"should trigger a change", func() {
												testDeleteTriggersChange(
													bazSvc1,
								...
								When(
									"first referenced service is recreated", func() {
										It(
											"should trigger a change", func() {
												testUpsertTriggersChange(bazSvc1, state.ClusterStateChange)
											},
								...
								When(
									"third referenced service is added", func() {
										It(
											"should trigger a change", func() {
								...
								When(
									"third referenced service is updated", func() {
										It(
											"should trigger a change", func() {
												testUpsertTriggersChange(bazSvc3, state.ClusterStateChange)
											},
								...
								When(
									"second referenced service is deleted", func() {
										It(
											"should not trigger a change", func() {
												testDeleteTriggersChange(
													bazSvc2,
								...
								When(
									"final referenced service is deleted", func() {
										It(
											"should not trigger a change", func() {
												testDeleteTriggersChange(
													bazSvc3,
				...
				Describe(
					"namespace changes", Ordered, func() {
						var (
						...
						When(
							"a namespace is created that is not linked to a listener", func() {
								It(
									"does not trigger an update", func() {
						...
						When(
							"a namespace is created that is linked to a listener", func() {
								It(
									"triggers an update", func() {
						...
						When(
							"a namespace is deleted that is not linked to a listener", func() {
								It(
									"does not trigger an update", func() {
										processor.CaptureDeleteChange(
											nsNoLabels,
						...
						When(
							"a namespace is deleted that is linked to a listener", func() {
								It(
									"triggers an update", func() {
						...
						When(
							"a namespace that is not linked to a listener has its labels changed to match a listener",
							func() {
								It(
									"triggers an update", func() {
						...
						When(
							"a gateway changes its listener's labels", func() {
								It(
									"triggers an update when a namespace that matches the new labels is created",
									func() {
						...
						When(
							"a namespace that is not linked to a listener has its labels removed", func() {
								It(
									"does not trigger an update", func() {
										ns.Labels = nil
										processor.CaptureUpsertChange(ns)
						...
						When(
							"a namespace that is linked to a listener has its labels removed", func() {
								It(
									"triggers an update when labels are removed", func() {
				...
				Describe(
					"NginxProxy resource changes", Ordered, func() {
						paramGC := gc.DeepCopy()
						...
						It(
							"handles upserts for an NginxProxy", func() {
						...
						It(
							"captures changes for an NginxProxy", func() {
						...
						It(
							"handles deletes for an NginxProxy", func() {
				...
				Describe(
					"NGF Policy resource changes", Ordered, func() {
						var (
							gw              *v1.Gateway
							route           *v1.HTTPRoute
						...
						*/
						...
						When(
							"a policy is created that references a resource that is not in the last graph", func() {
								It(
									"reports no changes", func() {
						...
						When(
							"the resource the policy references is created", func() {
								It(
									"populates the graph with the policy", func() {
										processor.CaptureUpsertChange(gw)
						...
						When(
							"the policy is updated", func() {
								It(
									"captures changes for a policy", func() {
						...
						When(
							"the policy is deleted", func() {
								It(
									"removes the policy from the graph", func() {
										processor.CaptureDeleteChange(
				...
				Describe(
					"SnippetsFilter resource changed", Ordered, func() {
						...
						It(
							"handles upserts for a SnippetsFilter", func() {
						...
						It(
							"captures changes for a SnippetsFilter", func() {
						...
						It(
							"handles deletes for a SnippetsFilter", func() {
		...
		Describe(
			"Ensuring non-changing changes don't override previously changing changes", func() {
				...
				// -- this is done in 'Normal cases of processing changes'
				Describe(
					"Multiple Gateway API resource changes", Ordered, func() {
						It(
							"should report changed after multiple Upserts", func() {
								processor.CaptureUpsertChange(gc)
								processor.CaptureUpsertChange(gw1)
						...
						When(
							"a upsert of updated resources is followed by an upsert of the same generation", func() {
								It(
									"should report changed", func() {
						...
						It(
							"should report changed after upserting new resources", func() {
						...
						When(
							"resources are deleted followed by upserts with the same generations", func() {
								It(
									"should report changed", func() {
										// these are changing changes
						...
						It(
							"should report changed after deleting resources", func() {
				...
				Describe(
					"Deleting non-existing Gateway API resource", func() {
						It(
							"should not report changed after deleting non-existing", func() {
								processor.CaptureDeleteChange(&v1.GatewayClass{}, gcNsName)
								processor.CaptureDeleteChange(&v1.Gateway{}, gwNsName)
								processor.CaptureDeleteChange(&v1.HTTPRoute{}, hrNsName)
								processor.CaptureDeleteChange(&v1.HTTPRoute{}, hr2NsName)
				...
				Describe(
					"Multiple Kubernetes API resource changes", Ordered, func() {
						BeforeAll(
							func() {
								// Set up graph
								processor.CaptureUpsertChange(gc)
						...
						It(
							"should report changed after multiple Upserts of related resources", func() {
						...
						It(
							"should report not changed after multiple Upserts of unrelated resources", func() {
						...
						When(
							"upserts of related resources are followed by upserts of unrelated resources", func() {
								It(
									"should report changed", func() {
										// these are changing changes
						...
						When(
							"deletes of related resources are followed by upserts of unrelated resources", func() {
								It(
									"should report changed", func() {
										// these are changing changes
				...
				Describe(
					"Multiple Kubernetes API and Gateway API resource changes", Ordered, func() {
						It(
							"should report changed after multiple Upserts of new and related resources", func() {
						...
						It(
							"should report changed after upserting changed resources followed by upserting unrelated resources",
							func() {
								// these are changing changes
								processor.CaptureUpsertChange(gcUpdated)
								processor.CaptureUpsertChange(gw1Updated)
