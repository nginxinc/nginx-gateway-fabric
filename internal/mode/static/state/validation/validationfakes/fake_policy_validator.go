...
type FakePolicyValidator struct {
	...
	ValidateStub        func(policies.Policy, *policies.ValidationContext) []conditions.Condition
	validateMutex       sync.RWMutex
	validateArgsForCall []struct {
		arg1 policies.Policy
		arg2 *policies.ValidationContext
	}
...
func (fake *FakePolicyValidator) Validate(arg1 policies.Policy, arg2 *policies.ValidationContext) []conditions.Condition {
...
func (fake *FakePolicyValidator) ValidateCalls(stub func(policies.Policy, *policies.ValidationContext) []conditions.Condition) {
	fake.validateMutex.Lock()
	defer fake.validateMutex.Unlock()
	fake.ValidateStub = stub
}

func (fake *FakePolicyValidator) ValidateArgsForCall(i int) (policies.Policy, *policies.ValidationContext) {
	fake.validateMutex.RLock()
	defer fake.validateMutex.RUnlock()
