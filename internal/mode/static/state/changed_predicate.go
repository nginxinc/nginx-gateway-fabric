...
type stateChangedPredicate interface {
	...
	upsert(oldObject, newObject client.Object, nsname types.NamespacedName) bool
...
func (f funcPredicate) upsert(_, newObject client.Object, nsname types.NamespacedName) bool {
	return f.stateChanged(newObject, nsname)
}
...
func (alwaysProcess) upsert(_, _ client.Object, _ types.NamespacedName) bool { return true }
...
func (a annotationChangedPredicate) upsert(oldObject, newObject client.Object, _ types.NamespacedName) bool {
	if oldObject == nil {
		return true
	}
