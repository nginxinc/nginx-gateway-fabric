...
type FakeChangeProcessor struct {
	...
	ProcessStub        func() (bool, newstate.Configuration, newstate.Statuses)
	processMutex       sync.RWMutex
	processArgsForCall []struct {
	}
	processReturns struct {
		result1 bool
		result2 newstate.Configuration
		result3 newstate.Statuses
	}
...
func (fake *FakeChangeProcessor) Process() (bool, newstate.Configuration, newstate.Statuses) {
...
func (fake *FakeChangeProcessor) ProcessCalls(stub func() (bool, newstate.Configuration, newstate.Statuses)) {
	fake.processMutex.Lock()
	defer fake.processMutex.Unlock()
	fake.ProcessStub = stub
}

func (fake *FakeChangeProcessor) ProcessReturns(result1 bool, result2 newstate.Configuration, result3 newstate.Statuses) {
	fake.processMutex.Lock()
	defer fake.processMutex.Unlock()
...
func (fake *FakeChangeProcessor) ProcessReturnsOnCall(i int, result1 bool, result2 newstate.Configuration, result3 newstate.Statuses) {
	fake.processMutex.Lock()
	defer fake.processMutex.Unlock()
	fake.ProcessStub = nil
...
var _ newstate.ChangeProcessor = new(FakeChangeProcessor)
