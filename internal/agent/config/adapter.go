...
// NginxConfig implements observer.VersionedConfig
...
// GetVersion returns the version of the NginxConfig.
...
// Returns an observer.VersionedConfig to satisfy the VersionedConfigAdapter interface.
