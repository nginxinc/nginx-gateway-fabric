...
func (in *BaseHTTPConfig) DeepCopyInto(out *BaseHTTPConfig) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BaseHTTPConfig.
func (in *BaseHTTPConfig) DeepCopy() *BaseHTTPConfig {
	if in == nil {
		return nil
	}
	out := new(BaseHTTPConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *NginxProxySpec) DeepCopyInto(out *NginxProxySpec) {
	*out = *in
	...
	if in.BaseHTTPConfig != nil {
		in, out := &in.BaseHTTPConfig, &out.BaseHTTPConfig
		*out = new(BaseHTTPConfig)
		**out = **in
	}
}
